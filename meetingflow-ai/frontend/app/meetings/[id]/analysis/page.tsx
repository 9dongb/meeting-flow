...
function analysisToEditPayload(result: MeetingAnalysisResult, meeting: Meeting): MeetingAnalysisUpdatePayload {
...
function buildMailtoHref(draft: FollowUpEmailDraft) {
